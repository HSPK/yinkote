...
| 中文关键词 | 54.9 ms | 57.0 ms |
| 模糊搜索（含错拼） | 5.7 ms | 6.3 ms |
| 语义搜索 | 6.3 ms | 9.8 ms |
| 混合搜索 | 36.0 ms | 37.9 ms |
| 单条写入 | 3.0 ms | 19.7 ms |
| 批量写入吞吐 | — | ~3000 条/秒 |
...
设计已完成、代码待补：附件与 PDF 阅读器、CSL 引文渲染、Word/浏览器插件、
Agent 层、智能文献库与论文项目库、关系图谱、同步。详见 `docs/09-roadmap.md`。
